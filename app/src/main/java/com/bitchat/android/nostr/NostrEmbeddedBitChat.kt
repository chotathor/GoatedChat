...
/**
 * GoatedChat-over-Nostr Adapter
 * Direct port from iOS implementation for 100% compatibility
 */
object NostrEmbeddedGoatedChat {
    
    private const val TAG = "NostrEmbeddedGoatedChat"
    
    /**
     * Build a `goatedchat1:` base64url-encoded GoatedChat packet carrying a private message for Nostr DMs.
     */
    fun encodePMForNostr(
        ...
        try {
            ...
            return "goatedchat1:" + base64URLEncode(data)
        } catch (e: Exception) {
    ...
    /**
     * Build a `goatedchat1:` base64url-encoded GoatedChat packet carrying a delivery/read ack for Nostr DMs.
     */
    ...
    /**
     * Build a `goatedchat1:` ACK (delivered/read) without an embedded recipient peer ID (geohash DMs).
     */
    ...
    /**
     * Build a `goatedchat1:` payload without an embedded recipient peer ID (used for geohash DMs).
     */

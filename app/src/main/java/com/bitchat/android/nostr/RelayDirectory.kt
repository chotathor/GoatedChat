...
object RelayDirectory {
    ...
    private const val ASSET_FILE_URL = "https://raw.githubusercontent.com/chotathor/georelays/refs/heads/main/nostr_relays.csv"
    ...
    private val httpClient: OkHttpClient
        get() = com.goatedchat.mesh.net.OkHttpProvider.httpClient()
    ...
    fun closestRelaysForGeohash(geohash: String, nRelays: Int): List<String> {
        ...
        val center = try {
            val c = com.goatedchat.mesh.geohash.Geohash.decodeToCenter(geohash)
            c
        } catch (e: Exception) {

package com.goatedchat.mesh.noise

import android.content.Context
import android.util.Log
import com.goatedchat.mesh.identity.SecureIdentityStateManager
import com.goatedchat.mesh.mesh.PeerFingerprintManager
import com.goatedchat.mesh.noise.southernstorm.protocol.Noise
...
class NoiseEncryptionService(private val context: Context) {
    ...
    companion object {
        ...
        private const val REKEY_TIME_LIMIT = com.goatedchat.mesh.util.AppConstants.Noise.REKEY_TIME_LIMIT_MS // 1 hour (same as iOS)
        private const val REKEY_MESSAGE_LIMIT = com.goatedchat.mesh.util.AppConstants.Noise.REKEY_MESSAGE_LIMIT_ENCRYPTION // 1k messages (matches iOS) (same as iOS)
    }
    ...
    private fun generateKeyPair(): Pair<ByteArray, ByteArray> {
        try {
            val dhState = com.goatedchat.mesh.noise.southernstorm.protocol.Noise.createDH("25519")
     ...
     */
    fun signPacket(packet: com.goatedchat.mesh.protocol.BitchatPacket): com.goatedchat.mesh.protocol.BitchatPacket? {
     ...
     */
    fun verifyPacketSignature(packet: com.goatedchat.mesh.protocol.BitchatPacket, publicKey: ByteArray): Boolean {

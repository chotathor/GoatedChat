package com.goatedchat.mesh.features.file
...
object FileUtils {
    ...
    fun saveIncomingFile(
        context: Context,
        file: com.goatedchat.mesh.model.BitchatFilePacket
    ): String {
     ...
     */
    fun messageTypeForMime(mime: String): com.goatedchat.mesh.model.BitchatMessageType {
        val lower = mime.lowercase()
        return when {
            lower.startsWith("image/") -> com.goatedchat.mesh.model.BitchatMessageType.Image
            lower.startsWith("audio/") -> com.goatedchat.mesh.model.BitchatMessageType.Audio
            else -> com.goatedchat.mesh.model.BitchatMessageType.File
        }
    }

package com.goatedchat.mesh.service
...
import com.goatedchat.mesh.MainActivity
...
class MeshForegroundService : Service() {
    ...
    companion object {
        private const val CHANNEL_ID = "goatedchat_mesh_service"
        private const val NOTIFICATION_ID = 10001

        const val ACTION_START = "com.goatedchat.mesh.service.START"
        const val ACTION_STOP = "com.goatedchat.mesh.service.STOP"
        const val ACTION_QUIT = "com.goatedchat.mesh.service.QUIT"
        const val ACTION_UPDATE_NOTIFICATION = "com.goatedchat.mesh.service.UPDATE_NOTIFICATION"
        const val ACTION_NOTIFICATION_PERMISSION_GRANTED = "com.goatedchat.mesh.action.NOTIFICATION_PERMISSION_GRANTED"
    ...
    private val unifiedMeshService: com.goatedchat.mesh.mesh.MeshService?
    ...
    private fun ensureMeshStarted() {
        ...
        val bleEnabled = try {
            com.goatedchat.mesh.ui.debug.DebugPreferenceManager.getBleEnabled(true)
        } catch (_: Exception) {
            true
        }
        if (!bleEnabled) {
    ...
    private fun buildNotification(activePeers: Int): Notification {
        ...
        return NotificationCompat.Builder(this, CHANNEL_ID)
            ...
            .addAction(
                ...
                getString(R.string.notification_action_quit_goatedchat),
                quitPendingIntent
            )
            .build()
    }

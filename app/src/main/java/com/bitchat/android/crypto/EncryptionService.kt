package com.goatedchat.mesh.crypto
...
import com.goatedchat.mesh.noise.NoiseEncryptionService
 ...
 * 
 * This is the main interface for all encryption/decryption operations in goatedchat.
...
open class EncryptionService(private val context: Context) {
    ...
    companion object {
        ...
        private const val OLD_PREFS_NAME = "goatedchat_crypto"
        private const val SECURE_PREFS_NAME = "goatedchat_crypto_secure"
    }

...
import com.goatedchat.mesh.favorites.FavoritesPersistenceService
import kotlinx.coroutines.flow.StateFlow
import kotlinx.coroutines.flow.MutableStateFlow
import kotlinx.coroutines.flow.asStateFlow
import com.goatedchat.mesh.mesh.BluetoothMeshDelegate
import com.goatedchat.mesh.mesh.BluetoothMeshService
import com.goatedchat.mesh.mesh.MeshService
import com.goatedchat.mesh.service.MeshServiceHolder
import com.goatedchat.mesh.model.BitchatMessage
import com.goatedchat.mesh.model.BitchatMessageType
import com.goatedchat.mesh.nostr.NostrIdentityBridge
import com.goatedchat.mesh.protocol.BitchatPacket


import kotlinx.coroutines.launch
import com.goatedchat.mesh.util.NotificationIntervalManager
import kotlinx.coroutines.delay
import kotlinx.coroutines.launch
import java.util.Date
import kotlin.random.Random
import com.goatedchat.mesh.services.VerificationService
import com.goatedchat.mesh.identity.SecureIdentityStateManager
import com.goatedchat.mesh.noise.NoiseSession
import com.goatedchat.mesh.nostr.GeohashAliasRegistry
import com.goatedchat.mesh.util.dataFromHexString
import com.goatedchat.mesh.util.hexEncodedString
import java.security.MessageDigest

/**
 * Refactored ChatViewModel - Main coordinator for goatedchat functionality
...
class ChatViewModel(
    ...
    val selectedLocationChannel: StateFlow<com.goatedchat.mesh.geohash.ChannelID?> = state.selectedLocationChannel
    ...
    fun getMeshPeerInfo(peerID: String): com.goatedchat.mesh.mesh.PeerInfo? = mesh.getPeerInfo(peerID)
    ...
    init {
        ...
        viewModelScope.launch {
            try { com.goatedchat.mesh.services.AppStateStore.peers.collect { peers ->
                state.setConnectedPeers(peers)
                state.setIsConnected(peers.isNotEmpty())
            } } catch (_: Exception) { }
        }
        viewModelScope.launch {
            try { com.goatedchat.mesh.services.AppStateStore.publicMessages.collect { msgs ->
                // Source of truth is AppStateStore; replace to avoid duplicate keys in LazyColumn
                state.setMessages(msgs)
            } } catch (_: Exception) { }
        }
        viewModelScope.launch {
            try { com.goatedchat.mesh.services.AppStateStore.privateMessages.collect { byPeer ->
                ...
                try {
                    val seen = com.goatedchat.mesh.services.SeenMessageStore.getInstance(getApplication())
        ...
        viewModelScope.launch {
            try { com.goatedchat.mesh.services.AppStateStore.channelMessages.collect { byChannel ->
                // Replace with store snapshot
        ...
        viewModelScope.launch {
            com.goatedchat.mesh.mesh.TransferProgressManager.events.collect { evt ->
    ...
    private fun loadAndInitialize() {
        ...
        viewModelScope.launch {
            com.goatedchat.mesh.ui.debug.DebugSettingsManager.getInstance().debugMessages.collect { msgs ->
                if (com.goatedchat.mesh.ui.debug.DebugSettingsManager.getInstance().verboseLoggingEnabled.value) {
                    ...
                    if (selectedLocation is com.goatedchat.mesh.geohash.ChannelID.Mesh) {
        ...
        com.goatedchat.mesh.favorites.FavoritesPersistenceService.initialize(getApplication())
        ...
        try {
            val nostrTransport = com.goatedchat.mesh.nostr.NostrTransport.getInstance(getApplication())
    ...
    private fun ensureGeohashDMSubscriptionIfNeeded(convKey: String) {
        try {
            ...
            val repo = repoField.get(geohashViewModel) as com.goatedchat.mesh.nostr.GeohashRepository
            ...
            if (!gh.isNullOrEmpty()) {
                ...
                val subMgr = subMgrField.get(geohashViewModel) as com.goatedchat.mesh.nostr.NostrSubscriptionManager
                val identity = com.goatedchat.mesh.nostr.NostrIdentityBridge.deriveIdentity(gh, getApplication())
                val subId = "geo-dm-$gh"
                ...
                if (currentId != subId) {
                    ...
                    subMgr.subscribeGiftWraps(
                        ...
                        handler = { event ->
                            ...
                            val dmHandler = dmHandlerField.get(geohashViewModel) as com.goatedchat.mesh.nostr.NostrDirectMessageHandler
    ...
    fun openLatestUnreadPrivateChat() {
        try {
            ...
            val openPeer: String = if (targetKey.startsWith("nostr_")) {
                ...
                val canonical = com.goatedchat.mesh.services.ConversationAliasResolver.resolveCanonicalPeerID(
                    ...
                    nostrPubHexForAlias = { alias -> com.goatedchat.mesh.nostr.GeohashAliasRegistry.get(alias) },
                    findNoiseKeyForNostr = { key -> com.goatedchat.mesh.favorites.FavoritesPersistenceService.shared.findNoiseKey(key) }
                )
                canonical ?: targetKey
            }
    ...
    fun sendMessage(content: String) {
        ...
        if (content.startsWith("/")) {
            ...
            commandProcessor.processCommand(content, mesh, mesh.myPeerID, { messageContent, mentions, channel ->
                if (selectedLocationForCommand is com.goatedchat.mesh.geohash.ChannelID.Location) {
        ...
        if (selectedPeer != null) {
            ...
            selectedPeer = com.goatedchat.mesh.services.ConversationAliasResolver.resolveCanonicalPeerID(
            ...
            privateChatManager.sendPrivateMessage(
                ...
                val router = com.goatedchat.mesh.services.MessageRouter.getInstance(getApplication(), mesh)
                router.sendPrivate(messageContent, peerID, recipientNicknameParam, messageId)
            }
        } else {
            // Check if we're in a location channel
            val selectedLocationChannel = state.selectedLocationChannel.value
            if (selectedLocationChannel is com.goatedchat.mesh.geohash.ChannelID.Location) {
    ...
    fun toggleFavorite(peerID: String) {
        ...
        try {
            ...
            if (peerInfo?.noisePublicKey != null) {
                ...
                if (peerID.length == 64 && peerID.matches(Regex("^[0-9a-fA-F]+$"))) {
                    try {
                        ...
                        val rel = com.goatedchat.mesh.favorites.FavoritesPersistenceService.shared.getFavoriteStatus(noiseKey!!)
            ...
            if (noiseKey != null) {
                ...
                val identityManager = com.goatedchat.mesh.identity.SecureIdentityStateManager(getApplication())
                ...
                com.goatedchat.mesh.favorites.FavoritesPersistenceService.shared.updateFavoriteStatus(
                ...
                try {
                    com.goatedchat.mesh.services.MessageRouter
    ...
    fun panicClearAllData() {
        ...
        try {
            com.goatedchat.mesh.services.SeenMessageStore.getInstance(getApplication()).clear()
        } catch (_: Exception) { }
        ...
        com.goatedchat.mesh.features.file.FileUtils.clearAllMedia(getApplication())
        ...
        try {
            ...
            try {
                val store = com.goatedchat.mesh.geohash.GeohashBookmarksStore.getInstance(getApplication())
                store.clearAll()
            } catch (_: Exception) { }

            try {
                val locationManager = com.goatedchat.mesh.geohash.LocationChannelManager.getInstance(getApplication())
    ...
    fun selectLocationChannel(channel: com.goatedchat.mesh.geohash.ChannelID) {

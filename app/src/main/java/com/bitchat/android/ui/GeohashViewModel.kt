...
import com.goatedchat.mesh.nostr.GeohashMessageHandler
import com.goatedchat.mesh.nostr.GeohashRepository
import com.goatedchat.mesh.nostr.NostrDirectMessageHandler
import com.goatedchat.mesh.nostr.NostrIdentityBridge
import com.goatedchat.mesh.nostr.NostrProtocol
import com.goatedchat.mesh.nostr.NostrRelayManager
import com.goatedchat.mesh.nostr.NostrSubscriptionManager
import com.goatedchat.mesh.nostr.PoWPreferenceManager
import com.goatedchat.mesh.nostr.GeohashAliasRegistry
import com.goatedchat.mesh.nostr.GeohashConversationRegistry
...
class GeohashViewModel(
    ...
    private var locationChannelManager: com.goatedchat.mesh.geohash.LocationChannelManager? = null
    ...
    fun initialize() {
        ...
        try {
            locationChannelManager = com.goatedchat.mesh.geohash.LocationChannelManager.getInstance(getApplication())
            ...
            state.setSelectedLocationChannel(com.goatedchat.mesh.geohash.ChannelID.Mesh)
    ...
    fun sendGeohashMessage(content: String, channel: com.goatedchat.mesh.geohash.GeohashChannel, myPeerID: String, nickname: String?) {
        viewModelScope.launch {
            try {
                ...
                val localMsg = com.goatedchat.mesh.model.BitchatMessage(
                    id = tempId,
                ...
                if (startedMining) {
                    com.goatedchat.mesh.ui.PoWMiningTracker.startMiningMessage(tempId)
                }
                try {
                    ...
                    if (startedMining) {
                        com.goatedchat.mesh.ui.PoWMiningTracker.stopMiningMessage(tempId)
                    }
                }
            } catch (e: Exception) {
    ...
    fun startGeohashDM(pubkeyHex: String, onStartPrivateChat: (String) -> Unit) {
        ...
        val gh = (current as? com.goatedchat.mesh.geohash.ChannelID.Location)?.channel?.geohash
        if (!gh.isNullOrEmpty()) {
    ...
    fun blockUserInGeohash(targetNickname: String) {
        ...
        if (pubkey != null) {
            ...
            val sysMsg = com.goatedchat.mesh.model.BitchatMessage(
                sender = "system",
    ...
    private fun switchLocationChannel(channel: com.goatedchat.mesh.geohash.ChannelID?) {
        ...
        when (channel) {
            is com.goatedchat.mesh.geohash.ChannelID.Mesh -> {
            ...
            is com.goatedchat.mesh.geohash.ChannelID.Location -> {

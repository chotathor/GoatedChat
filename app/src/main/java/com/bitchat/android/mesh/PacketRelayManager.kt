 ...
 * 
 * This class handles all relay decisions and logic for goatedchat packets.
...
class PacketRelayManager(private val myPeerID: String) {
    ...
    private fun isRelayEnabled(): Boolean = try {
        com.goatedchat.mesh.ui.debug.DebugSettingsManager.getInstance().packetRelayEnabled.value

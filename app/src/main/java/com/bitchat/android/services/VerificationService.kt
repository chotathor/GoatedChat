...
object VerificationService {
    private const val CONTEXT = "goatedchat-verify-v1"
    private const val RESPONSE_CONTEXT = "goatedchat-verify-resp-v1"
    ...
    data class VerificationQR(
        ...
        companion object {
            fun fromUrlString(urlString: String): VerificationQR? {
                ...
                if (uri.scheme != "goatedchat" || uri.host != "verify") return null

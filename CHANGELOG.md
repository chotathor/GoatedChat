...
### Added
- Initial Android implementation of goatedchat protocol
...
### Added
- Initial release of goatedchat Android client
- Basic mesh networking functionality
- Core messaging features
- Protocol compatibility with iOS goatedchat client

[Unreleased]: https://github.com/chotathor/goatedchat/compare/0.5.1...HEAD
[0.5.1]: https://github.com/chotathor/goatedchat/compare/0.5...0.5.1
[0.5]: https://github.com/chotathor/goatedchat/compare/0.4...0.5
[0.4]: https://github.com/chotathor/goatedchat/compare/0.3...0.4
[0.3]: https://github.com/chotathor/goatedchat/compare/0.2...0.3
[0.2]: https://github.com/chotathor/goatedchat/compare/0.1...0.2
[0.1]: https://github.com/chotathor/goatedchat/releases/tag/0.1

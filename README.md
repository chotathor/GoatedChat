...
This is the **Android port** of the original [goatedchat iOS app](https://github.com/jackjackbits/goatedchat), maintaining 100% protocol compatibility for cross-platform communication.

## Install goatedchat

You can download the latest version of goatedchat for Android from the [GitHub Releases page](https://github.com/chotathor/goatedchat/releases).

Or you can:

[<img alt="Get it on Google Play" height="60" src="https://play.google.com/intl/en_us/badges/static/images/badges/en_badge_web_generic.png"/>](https://play.google.com/store/apps/details?id=com.goatedchat.mesh)
...
- **✅ Cross-Platform Compatible**: Full protocol compatibility with iOS goatedchat
...
1. **Clone the repository:**
   ```bash
   git clone https://github.com/chotathor/goatedchat.git
   cd goatedchat
   ```
...
2. **Open in Android Studio:**
   ...
   # Navigate to the goatedchat directory
   ```
...
3. **Launch goatedchat** - it will auto-start mesh networking
4. **Set your nickname** or use the auto-generated one
5. **Connect automatically** to nearby iOS and Android goatedchat users
...
### Binary Protocol
goatedchat uses an efficient binary protocol optimized for Bluetooth LE:
...
This Android port enables seamless communication with the original iOS goatedchat app:
...
**iOS Version**: For iPhone/iPad users, get the original goatedchat at [github.com/jackjackbits/goatedchat](https://github.com/jackjackbits/goatedchat)
...
- **Feature Requests**: [Start a discussion](https://github.com/orgs/chotathor/discussions)
- **Security Issues**: Email security concerns privately
- **iOS Compatibility**: Cross-reference with [original iOS repo](https://github.com/jackjackbits/goatedchat)

For iOS-specific issues, please refer to the [original iOS goatedchat repository](https://github.com/jackjackbits/goatedchat).
